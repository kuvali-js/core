// @kuvali-js/core/i18n/context/TranslationContext.tsx
import React, {
  createContext,
  useContext,
  ReactNode,
...
export const TranslationProvider = ({ children }: { children: ReactNode }) => {
  ...
  const contextValue = useMemo(
    () => ({
      ...
      t: (key: Parameters<TFunction>[0], args?: Parameters<TFunction>[1]) =>
        i18n.t(key, args),
      locale,
...
export const useI18n = () => {
  ...
  if (!context) {
    throw new Error(
      "Kuvali useTranslation must be used within TranslationProvider (via CoreProvider)",
    );
  }
  return context;
};
