...
export default function DebugScreen() {
  return (
    ...
    >
      ...
      {!__DEV__ && (
        <Text style={styles.warning}>Warning: This menu should be hidden in production.</Text>
      )}
    </ScrollView>
  );
}
...
const styles = StyleSheet.create({
  ...
  status: { marginTop: 30, color: '#333', padding: 10, backgroundColor: '#eee', borderRadius: 4 },
