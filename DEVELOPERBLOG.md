...
- [#] Wasted quite some time to make them show up "nice".
- [#] Wasted quite some time to have links to GitHub and links to NPM with the used version number, read from the package.json of the project.
