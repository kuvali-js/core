...
import { CoreProvider, useI18n } from '@kuvali/core'
...
describe('Kuvali Core/i18n integration', () => {
  ...
  describe('Initialization', () => {
    ...
    it('should throw specific error when used outside of provider', () => {
      const consoleSpy = jest.spyOn(console, 'error').mockImplementation(() => { });        // 1. Silence the console for this specific error

      expect(() => renderHook(() => useI18n())).toThrow("Kuvali i18n not initialized");    // 2. Assert exact error message
