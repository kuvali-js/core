...
export default {
  ...
  brand: {  // page
    ...
    "Exchange your cylinder": "Exchange your {brand: global.gasBrandShort} cylinder",
  ...
  cylinder: {   // page
    ...
    "for": "for",
    description: dt(" {count: plural} {new:literal} {weight} {brand: global.gasBrandShort} {gas} {cylinder: plural} {exchange}", {
      plural: {
  ...
  userCartPage: { // cart page
    appbartitle: "My Cart",
    cartItems: dt("{items: plural}",
      { plural: { items: { zero: "empty cart", one: "1 cart item", other: "{?} cart items" } }, }),
